...
data class AppStrings(
    ...
    val likeNotificationTitle: String,
    val likeNotificationMessage: String,
    val dealTestNotification: String,
    ...
    val passwordHintMinLength: String,
    val repeatPasswordHint: String,
    ...
    val notificationNewUpdates: String,
    val carFallback: String,
    val listingThumbnailDescription: String
)
...
val PolishStrings = AppStrings(
    ...
    likeNotificationTitle = "Polubienie!",
    likeNotificationMessage = "Twoje auto %s zostało właśnie polubione!",
    dealTestNotification = "Wyślij testowe powiadomienie",
    ...
    emailHint = "Adres e-mail",
    passwordHint = "Hasło",
    passwordHintMinLength = "Hasło (min. 6 znaków)",
    ...
    registerError = "Błąd rejestracji: %s",
    notificationChannelDescription = "Powiadomienia z aplikacji OtomotUZplus",
    notificationNewUpdates = "Sprawdź nowe zmiany!",
    carFallback = "Auto",
    listingThumbnailDescription = "Miniatura ogłoszenia"
)
...
val EnglishStrings = AppStrings(
    ...
    likeNotificationTitle = "Like!",
    likeNotificationMessage = "Your car %s was just liked!",
    dealTestNotification = "Send test notification",
    ...
    passwordHintMinLength = "Password (min. 6 chars)",
    ...
    registerError = "Registration error: %s",
    notificationChannelDescription = "Notifications from OtomotUZplus",
    notificationNewUpdates = "Check out new updates!",
    carFallback = "Car",
    listingThumbnailDescription = "Listing thumbnail"
)
